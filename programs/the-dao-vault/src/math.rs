...
mod tests {
    ...
    #[test]
    fn test_mgmt_fees_err() {
        let res = calc_carry_fees(10000000000000000000, 1000000000);
        /* 
        Err(AnchorError(AnchorError
            { error_name: "OverflowError",
            error_code_number: 6005,
            error_msg: "Failed to perform a math operation without an overflow",
            error_origin: None,
